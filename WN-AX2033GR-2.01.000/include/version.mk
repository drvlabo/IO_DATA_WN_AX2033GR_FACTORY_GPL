...
# __MSTC__, Ben add for internal FW version
INTERNAL_VERSION_NUMBER:=$(call qstrip,$(CONFIG_INTERNAL_VERSION_NUMBER))
...
MAC_QTY:=$(call qstrip,$(CONFIG_MAC_QTY))
MAC_QTY:=$(if $(MAC_QTY),$(MAC_QTY),1)
