...
# siteblock
$(eval $(call nf_add,IPT_SITEBLOCK,CONFIG_IP_NF_TARGET_SITEBLOCK, $(P_V4)ipt_SITEBLOCK))
...
$(eval $(call nf_add,EBTABLES_TIME,CONFIG_BRIDGE_EBT_TIME, $(P_EBT)ebt_time))
...
$(eval $(call nf_add,EBTABLES_SITEBLOCK,CONFIG_BRIDGE_EBT_SITEBLOCK, $(P_EBT)ebt_siteblock))
...
IPT_BUILTIN += $(EBTABLES_TIME-y)
IPT_BUILTIN += $(EBTABLES_SITEBLOCK-y)
