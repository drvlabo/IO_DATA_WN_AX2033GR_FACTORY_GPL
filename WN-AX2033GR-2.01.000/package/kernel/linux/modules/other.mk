...
define KernelPackage/sbdev
  SUBMENU:=$(OTHER_MENU)
  TITLE:=Siteblock CHAR device driver
  KCONFIG:=CONFIG_SBDEV
  FILES:=$(LINUX_DIR)/drivers/char/sbdev.ko
  AUTOLOAD:=$(call AutoLoad,30,sbdev)
endef

define KernelPackage/sbdev/description
 Kernel support for the Site Block char device
endef

$(eval $(call KernelPackage,sbdev))
