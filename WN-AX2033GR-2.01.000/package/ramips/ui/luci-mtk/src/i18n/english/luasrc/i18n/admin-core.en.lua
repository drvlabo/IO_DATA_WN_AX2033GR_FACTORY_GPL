...
NAT_IPv6_Passthrough = 'IPv6 Passthrough'
...
ipv6_lan_err6 = "Prefix Preferred Lifetime must be less than  Prefix Valid Lifetime"
ipv6_lan_err7 = "IPv6 Address range(Start) must be less than IPv6 Address range(End)"
-- IPv6 Advance
...
All = 'All'
Selected = 'Selected'
Remote_MGMT_Note_1 = '1. For UPnP to function normally, the HTTP service must be available for LAN computers using UPnP.'
Remote_MGMT_Note_2 = 'You may also need to create a Firewall rule.'
Remote_MGMT_Note_3 = 'Please insert the MAC Address in this format 00:00:00:00:00:00'
...
time_warn3 = 'Please input a number between 1970 and 2050 in years.'
...
Yes = "Yes"
No = "No"
Photo_Note = "2. ZyXEL Photo app can't work properly if HTTP (WWW) port 80 is changed."
...
expert_ddns_note3 = "and get a free accessible-from-anywhere network name as well as other Zyxel services."
