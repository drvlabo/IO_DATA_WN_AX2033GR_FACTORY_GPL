...
-- convert special characters in input string to html code (only below characters will convert: ( [ < > & " ' \ ) )
-- @param aValue      string to be converted
-- @return                 HTTP encoded string
...
-- convert HTML code in input string to special characters
-- @param aValue      string to be converted
-- @return            HTMO decode string
